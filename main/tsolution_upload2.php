...
<body>
    ...
    <div id="container">
        <div class="row my-5">
            <h3 class="h3 text-center">Upload text book solution</h3>
        </div>
        <div class="row">
            <form action="" method="post">
              <div class="mb-3">
                    <label for="std" class="form-label">Standard</label>
                    <input type="text" name="std" id="std" class="form-control" placeholder="enter your standard e.g 6th"
                        aria-describedby="helpId" />
                </div>

                <div class="mb-3">
                    <label for="subject" class="form-label">Subject</label>
                    <input type="text" name="subject" id="subject" class="form-control" placeholder="enter your subject e.g english"
                        aria-describedby="helpId" />
                </div>

                <div class="mb-3">
                    <label for="chapter" class="form-label">Chapter Name</label>
                    <input type="text" name="chapter" id="chapter" class="form-control" placeholder="enter your chapter e.g natural resources"
                        aria-describedby="helpId" />
                </div>

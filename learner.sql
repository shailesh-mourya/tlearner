...
CREATE TABLE `t_solution` (
  `id` int(30) NOT NULL,
  `std` varchar(40) NOT NULL,
  `subject` varchar(40) NOT NULL,
  `chapter` varchar(40) NOT NULL,
  `section` varchar(30) NOT NULL,
  `question_no` varchar(40) NOT NULL,
...
--
-- Dumping data for table `t_solution`
--

INSERT INTO `t_solution` (`id`, `std`, `subject`, `chapter`, `section`, `question_no`, `question`, `answer`, `page_no`) VALUES
(1, '8th', 'english', 'life cycle of stars', 'exercise', 'Q 3.2', 'Why do stars evolve?', 'Star loses its energy constantly due to continuous emission of light and energy. This means that the temperature of a star decrease continuously and hence it gas pressure which thereby decreases it stability .But we know a star is very stable. So, to maintain the stability of a star, its temperature is maintained constant with the help of energy released by the burning of  fuel at it center .this burning and therefore the decrease in the amount of fuel is the reason for the evolution in the stars. The what know.', '134'),
